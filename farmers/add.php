...
//    }
    ...
    if ($validation['valid'] == TRUE) {
        $sql = "INSERT INTO `farmers` ( `f_no` ,`f_id` , `f_name` , `f_locallity` ,  `f_ac` ,  `f_phone`, `last_paid` ) VALUES(  '{$_POST['f_no']}' ,'{$_POST['f_id']}' , '{$_POST['f_name']}' , '{$_POST['f_locallity']}' ,  '{$_POST['f_ac']}' ,  '{$_POST['f_phone']}' , '{$_POST['last_paid']}' ) ";
...
<?php echo $validation['id'] ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="last Paid on" name='last_paid'/> 
        </div>
    </div>
    <div class="control-group">
