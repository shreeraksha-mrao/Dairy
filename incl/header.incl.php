        ...
        <div id="top" class="page-header">
            ...
            <div id="navigation" class="navbar pull-right">
                ...
                <ul class="nav navbar-inner">
                    ...
                    <li><a href="<?php Page_Url() ?>farmers/index.php"> Dairy Farmers</a></li>
                    ...
                    <li><a href="<?php Page_Url() ?>view/index.php">Leader Board</a></li>
                    <li><a href="<?php Page_Url() ?>view/index2.php">View</a></li>
                </ul>
            </div> <!--end navigation-->
        </div>
