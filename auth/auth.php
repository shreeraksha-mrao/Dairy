...
//     var $database_logon = 'dairy7';       //Database NAME
...
class logmein {
    ...
    function dbconnect() {
        $this->connection = mysqli_connect($this->hostname_logon, $this->username_logon, $this->password_logon, $this->database_logon) or die('Unable to connect to the database');
        return;
    }
    ...
    function passwordreset($username, $user_table, $pass_column, $user_column) {
        ...
        //update database with new password
        $qry = "UPDATE " . $this->user_table . " SET " . $this->pass_column . "='" . $newpassword_db . "' WHERE " . $this->user_column . "=?";
        $stmt = mysqli_prepare($this->connection, $qry);
    ...
    function cratetable($tablename) {
        ...
        mysqli_query($this->connection, $qry) or die(mysqli_error($this->connection));
        return;
    }
