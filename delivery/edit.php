...
if (isset($_GET['id'])) {
    ...
    if (isset($_POST['submitted'])) {
        ...
        if ($validation['valid']) {
            ...
            $sql = "UPDATE `delivery` SET  `r_f_no` =  '{$_POST['r_f_no']}' ,  `r_kg` =  '{$_POST['r_kg']}' ,  `r_dt` =  '{$mysqldate}' ,  `r_deliverer` =  '{$_POST['r_deliverer']}' , `r_received_by` =  '{$_POST['r_received_by']}'  WHERE `id` = '$id' ";
