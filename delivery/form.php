...
<form action='' method='POST' class="form-horizontal" name="delivery"> 
    ...
    <div class="control-group">
        <label class="control-label" for="r_received_by"> Milk Received by:</label >
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="Receiver-X.." name='r_received_by' value='<?php echo isset($row)?stripslashes($row['r_received_by']):'' ?>'/> 
        </div>
    </div>
    <div class="control-group">
